...
module.exports = {
    data: new SlashCommandBuilder().setName('jankenbon').setDescription('Earn money with jankenbon!'),
    async execute(client, interaction) {
        ...
        collector.on('collect', async collected => {
            ...
            let winner = 0;
            if((playerChoice == 2 && botChoice == 1) || (playerChoice == 1 && botChoice == 0) || (playerChoice == 0 && botChoice == 2))
                winner = 2;
            if((playerChoice == 1 && botChoice == 2) || (playerChoice == 0 && botChoice == 1) || (playerChoice == 2 && botChoice == 0))
                winner = 1;
